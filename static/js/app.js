...
},{"../../vendor/vendor":32,"../models/Facet":5}],2:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":32,"../models/FacetItem":6}],3:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":32,"../views/Main":18}],4:[function(require,module,exports){
'use strict';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    (0, _vendor.$)('body').animate({ scrollTop: 0 }, 0);

    // Scroll to top
    // Check if the window is on the top. If not, then display the button
    (0, _vendor.$)(window).scroll(function () {
        var level = (0, _vendor.$)('nav.navbar').height() + (0, _vendor.$)('.jumbotron').height() + 60;
...
},{"../vendor/vendor":32,"./components/App":3,"bootstrap-material-design":25,"bootstrap/dist/js/bootstrap.min":28,"noty":30}],5:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":32,"../collections/FacetItem":2}],6:[function(require,module,exports){
'use strict';
...
with(obj||{}){
__p+='<div class="row"> <div class="col-xs-12"> <div id="panel-configure" class="panel panel-default"> <div class="panel-body"> <div class="col-md-8 col-md-offset-2"> <h3 class="text-center">Configure the uploaded database:</h3> </div> </div> </div> </div> </div>';
}
return __p;
};

},{"underscore":31}],8:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="panel-heading"> <h3 class="panel-title">Refine by '+
((__t=( name ))==null?'':__t)+
'</h3> </div> <div class="panel-body"> <ul class="facet-items"> ';
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row"> <div class="col-xs-12"> <div class="jumbotron"> <h1>Welcome to CompleteSearch</h1> <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus scelerisque est nec nisi efficitur, ut mattis odio porttitor. Pellentesque tempus vitae nibh non lobortis. Integer sagittis massa non diam ultrices ultricies. </p> </div> </div> </div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div id="nav"></div> <div class="container"> <div id="intro"></div> <div id="content"></div> </div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row"> <div class="col-xs-12 col-sm-8"> <div class="panel panel-default"> <div class="panel-body"> <div class="search-bar"> <div class="input-group"> <input type="search" id="search" class="form-control" placeholder="Search..."> <span class="input-group-btn"> <button id="searchBtn" class="btn btn-raised btn-primary" type="button"> <i class="fa fa-search" aria-hidden="true"></i> </button> </span> </div> </div> </div> </div> <div class="panel panel-default"> <div class="panel-heading">Result</div> <div class="panel-body search-result"> <div id="hits"></div> <div id="empty-text">Nothing to show.</div> <div id="loader"></div> </div> </div> </div> <div class="col-sm-4 hidden-xs" id="sidebar"> <div id="facets"></div> </div> </div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row"> <div class="col-xs-12"> <div id="panel-upload" class="panel panel-default"> <div class="panel-body"> <div class="col-md-6 col-md-offset-3"> <h4>You can upload your own database, using the form below:</h4> <div id="upload-form" class="form-group"> <input type="file" id="inputFile" name="file"> <div class="input-group"> <input id="fileName" type="text" readonly="" class="form-control" placeholder="Select a file..."> <span class="input-group-btn input-group-sm"> <button type="button" id="" class="btn btn-fab btn-fab-mini"> <i class="fa fa-upload" aria-hidden="true"></i> </button> </span> </div> </div> <p><strong>*Note: </strong>XML, CSV, TSV and TXT (with whatever separated data) are only accepted.</p> <div class="text-center"> <button id="uploadBtn" class="btn btn-raised btn-primary">Upload</button> </div> </div> </div> </div> </div> </div>';
}
return __p;
};
...
},{"../../vendor/vendor":32,"../templates/configure.jst":7}],15:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":32,"../templates/facet.jst":8}],16:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":32,"../collections/Facet":1,"../templates/facet.jst":8,"./Facet":15}],17:[function(require,module,exports){
'use strict';
...
var _intro = require('../templates/intro.jst');
...
},{"../../vendor/vendor":32,"../templates/intro.jst":9}],18:[function(require,module,exports){
'use strict';
...
exports.default = _vendor.Marionette.View.extend({
    ...
    onRender: function onRender() {
        this.showChildView('nav', new _Nav2.default());
        this.showChildView('intro', new _Intro2.default());
...
},{"../../vendor/vendor":32,"../templates/main.jst":10,"./Configure":14,"./Intro":17,"./Nav":19,"./Search":20,"./Upload":21}],19:[function(require,module,exports){
'use strict';
...
var _nav = require('../templates/nav.jst');
...
},{"../../vendor/vendor":32,"../templates/nav.jst":11}],20:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":32,"../templates/search.jst":12,"./FacetList":16}],21:[function(require,module,exports){
'use strict';
            ...
            $.ajax({
                ...
                success: function success(data) {
                    ...
                    if (data.success) {
                        ...
                        var contentRegion = app.getRegion('app').currentView.getRegion('content');
                        contentRegion.empty();
...
},{"../../vendor/vendor":32,"../templates/upload.jst":13,"./Search":20}],22:[function(require,module,exports){
...
},{"backbone":24,"backbone.marionette":22,"jquery":29,"underscore":31}]},{},[4]);
