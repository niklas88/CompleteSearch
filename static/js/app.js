...
exports.default = _vendor.Backbone.Collection.extend({
    model: _Config2.default,
    url: 'get_fields/'
});

},{"../../vendor/vendor":32,"../models/Config":6}],2:[function(require,module,exports){
'use strict';
...
var _Facet = require('../models/Facet');
...
exports.default = _vendor.Backbone.Collection.extend({
    model: _Facet2.default,
    url: 'get_facets/'
});

},{"../../vendor/vendor":32,"../models/Facet":7}],3:[function(require,module,exports){
'use strict';
...
var _FacetItem = require('../models/FacetItem');
...
exports.default = _vendor.Backbone.Collection.extend({
    model: _FacetItem2.default
});

},{"../../vendor/vendor":32,"../models/FacetItem":8}],4:[function(require,module,exports){
'use strict';
...
exports.default = _vendor.Marionette.Application.extend({
    ...
    initialize: function initialize() {
        ...
        this.on('start', function () {
            _this.showView(new _Main2.default());
        });
    },
    getContentRegion: function getContentRegion() {
        return this.getRegion('app').currentView.getRegion('content');
    }
});

},{"../../vendor/vendor":32,"../views/Main":19}],5:[function(require,module,exports){
'use strict';
...
var _bootstrap = require('bootstrap/dist/js/bootstrap.min');

var _bootstrap2 = _interopRequireDefault(_bootstrap);

var _bootstrapMaterialDesign = require('bootstrap-material-design');

var _bootstrapMaterialDesign2 = _interopRequireDefault(_bootstrapMaterialDesign);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    (0, _vendor.$)('body').addClass('loaded');

    // Scroll to top
    // Check if the window is on the top. If not, then display the button
    (0, _vendor.$)(window).scroll(function () {
        var level = (0, _vendor.$)('.page-header').height();
        if ((0, _vendor.$)(this).scrollTop() > level) {
            (0, _vendor.$)('#scrollToTop').fadeIn();
        } else {
            (0, _vendor.$)('#scrollToTop').fadeOut();
        }
    });

    // Click event to scroll to top
    (0, _vendor.$)('#scrollToTop').click(function () {
        (0, _vendor.$)('html, body').animate({
            scrollTop: 0
        }, 500);
        return false;
    });
    ...
    _vendor.$.noty.defaults.layout = 'bottomRight';
    _vendor.$.noty.defaults.theme = 'relax';
    _vendor.$.noty.defaults.type = 'information';
    _vendor.$.noty.defaults.timeout = 5000;
...
},{"../vendor/vendor":32,"./components/App":4,"bootstrap-material-design":25,"bootstrap/dist/js/bootstrap.min":28,"noty":30}],6:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":32}],7:[function(require,module,exports){
'use strict';
...
var _FacetItem = require('../collections/FacetItem');
...
exports.default = _vendor.Backbone.Model.extend({
    ...
    initialize: function initialize() {
        this.set('facetItems', new _FacetItem2.default());
    }
});

},{"../../vendor/vendor":32,"../collections/FacetItem":3}],8:[function(require,module,exports){
'use strict';
...
},{"../../vendor/vendor":32}],9:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="main main-raised"> <div class="container"> <div class="completesearch-configure text-center"> <div class="row"> <div class="col-md-6 col-md-offset-3"> <h2 class="title">Configure database</h2> <h5 class="description"> Please configure the uploaded database to proceed. </h5> <form id="config-form" class="form-horizontal text-left"> <div class="form-group"> <label class="col-md-5 control-label" for="--show"> Full Text <span class="config-tooltip" data-toggle="tooltip" data-placement="top" title="" data-container="body" data-original-title="tooltip">[?]</span> </label> <div class="col-md-4"> ';
 _.each(fields, (field) => { 
__p+=' <div class="checkbox"> <label for="'+
((__t=( '--full-text-' + field.name.replace(' ', '-') ))==null?'':__t)+
'"> <input type="checkbox" name="--full-text" id="'+
((__t=( '--full-text-' + field.name.replace(' ', '-') ))==null?'':__t)+
'" value="'+
...
__p+=' </div> <div class="col-md-3"> <button id="--full-text-select-all" class="btn btn-primary btn-xs" type="button">Select All</button> </div> </div> <div class="form-group"> <label class="col-md-5 control-label" for="--allow-multiple-items"> Multiple Items Fields <span class="config-tooltip" data-toggle="tooltip" data-placement="top" title="" data-container="body" data-original-title="tooltip">[?]</span> </label> <div class="col-md-4"> ';
 _.each(fields, (field) => { 
__p+=' <div class="checkbox"> <label for="'+
((__t=( '--allow-multiple-items-' + field.name.replace(' ', '-') ))==null?'':__t)+
'"> <input type="checkbox" name="--allow-multiple-items" id="'+
((__t=( '--allow-multiple-items-' + field.name.replace(' ', '-') ))==null?'':__t)+
'" value="'+
((__t=( field ))==null?'':__t)+
'"> '+
...
__p+=' </div> <div class="col-md-3"> <button id="--allow-multiple-items-select-all" class="btn btn-primary btn-xs" type="button">Select All</button> </div> </div> <div class="form-group"> <label class="col-md-5 control-label" for="textinput"> Multiple Items Fields Separator <span class="config-tooltip" data-toggle="tooltip" data-placement="top" title="" data-container="body" data-original-title="tooltip">[?]</span> </label> <div class="col-md-7"> <input id="--within-field-separator" name="--within-field-separator" type="text" class="form-control" placeholder=";"> </div> </div> <div class="form-group"> <label class="col-md-5 control-label" for="--filter"> Filters <span class="config-tooltip" data-toggle="tooltip" data-placement="top" title="" data-container="body" data-original-title="tooltip">[?]</span> </label> <div class="col-md-4"> ';
 _.each(fields, (field) => { 
__p+=' <div class="checkbox"> <label for="'+
((__t=( '--filter-' + field.name.replace(' ', '-') ))==null?'':__t)+
...
__p+=' </div> <div class="col-md-3"> <button id="--filter-select-all" class="btn btn-primary btn-xs" type="button">Select All</button> </div> </div> <div class="form-group"> <label class="col-md-5 control-label" for="--facets"> Facets <span class="config-tooltip" data-toggle="tooltip" data-placement="top" title="" data-container="body" data-original-title="tooltip">[?]</span> </label> <div class="col-md-4"> ';
 _.each(fields, (field) => { 
__p+=' <div class="checkbox"> <label for="'+
((__t=( '--facets-' + field.name.replace(' ', '-') ))==null?'':__t)+
'"> <input type="checkbox" name="--facets" id="'+
((__t=( '--facets-' + field.name.replace(' ', '-') ))==null?'':__t)+
'" value="'+
((__t=( field ))==null?'':__t)+
'"> '+
...
__p+=' </div> <div class="col-md-3"> <button id="--facets-select-all" class="btn btn-primary btn-xs" type="button">Select All</button> </div> </div> <hr> <div class="form-group"> <label class="col-md-5 control-label" for="--show"> Show <span class="config-tooltip" data-toggle="tooltip" data-placement="top" title="" data-container="body" data-original-title="tooltip">[?]</span> </label> <div class="col-md-4"> ';
 _.each(fields, (field) => { 
__p+=' <div class="checkbox"> <label for="'+
((__t=( '--show-' + field.name.replace(' ', '-') ))==null?'':__t)+
...
__p+=' </div> <div class="col-md-3"> <button id="--show-select-all" class="btn btn-primary btn-xs" type="button">Select All</button> </div> </div> <div class="form-group"> <label class="col-md-5 control-label" for="--title-field"> Title Field <span class="config-tooltip" data-toggle="tooltip" data-placement="top" title="" data-container="body" data-original-title="tooltip">[?]</span> </label> <div class="col-md-7"> <select id="--title-field" name="--title-field" class="form-control"> <option value="--">--</option> ';
 _.each(fields, (field) => { 
__p+=' <option value="'+
((__t=( field.name ))==null?'':__t)+
'">'+
...
__p+=' </select> </div> </div> </form> <button id="save-database-config-button" class="btn btn-raised btn-primary">Save</button> </div> </div> </div> </div> </div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="card"> <div class="content"> <h4 class="card-title">Refine by '+
((__t=( name ))==null?'':__t)+
'</h4> <div class="card-description"> <ul class="facet-items"> ';
...
((__t=( item.attributes.count ))==null?'':__t)+
'</span> </li> ';
 }); 
__p+=' </ul> <div class="facet-items-top"> <hr> <a href="javascript:void(0)" class="btn btn-primary btn-sm top-5">Top 5</a> <a href="javascript:void(0)" class="btn btn-primary btn-sm top-50">Top 50</a> <a href="javascript:void(0)" class="btn btn-primary btn-sm top-100">Top 100</a> <a href="javascript:void(0)" class="btn btn-primary btn-sm top-all">All</a> </div> </div> </div> </div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="main main-raised"> <div class="container"> <div class="completesearch-description text-center"> <div class="row"> <div class="col-md-8 col-md-offset-2"> <h5 class="description">! CompleteSearch Description !</h5> </div> </div> </div> <div class="completesearch-features"> <div class="row"> <div class="col-md-8 col-md-offset-2 text-center"> <h2 class="title">Features</h2> </div> </div> <div class="row"> <div class="col-md-3"> <div class="info info-horizontal"> <div class="icon icon-rose"> <i class="fa fa-database" aria-hidden="true"></i> </div> <div class="description"> <h4 class="info-title">Custom databases</h4> <p>Upload your own database and perform a search in it.</p> </div> </div> </div> <div class="col-md-3"> <div class="info info-horizontal"> <div class="icon icon-rose"> <i class="fa fa-cogs" aria-hidden="true"></i> </div> <div class="description"> <h4 class="info-title">CompleteSearch</h4> <p>Use of a powerful search engine.</p> <a href="#">Read more...</a> </div> </div> </div> <div class="col-md-3"> <div class="info info-horizontal"> <div class="icon icon-rose"> <i class="material-icons">mode_edit</i> </div> <div class="description"> <h4 class="info-title">Feature 3</h4> <p>Ut euismod sed mi et suscipit. Donec euismod feugiat odio. In mattis in dui nec ullamcorper. Integer sollicitudin varius lectus sit amet faucibus.</p> </div> </div> </div> <div class="col-md-3"> <div class="info info-horizontal"> <div class="icon icon-rose"> <i class="material-icons">mode_edit</i> </div> <div class="description"> <h4 class="info-title">Feature 4</h4> <p>Ut euismod sed mi et suscipit. Donec euismod feugiat odio. In mattis in dui nec ullamcorper. Integer sollicitudin varius lectus sit amet faucibus.</p> </div> </div> </div> </div> </div> <div class="completesearch-start"> <div class="row"> <div class="col-md-12 text-center"> <button id="start-button" class="btn btn-primary btn-round">Start</button> </div> </div> </div> </div> </div>';
}
return __p;
};

},{"underscore":31}],12:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<nav class="navbar navbar-transparent navbar-absolute"> <div class="container"> <div class="navbar-header"> <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-example"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button> <a class="navbar-brand" href=".">CompleteSearch</a> </div> <div class="collapse navbar-collapse"> <ul class="nav navbar-nav navbar-right"> <li> <a href="#"> <i class="material-icons">help</i> Help </a> </li> <li> <a href="#"> <i class="material-icons">settings</i> Settings </a> </li> </ul> </div> </div> </nav> <div class="page-header header-filter" data-parallax="active" style="background-image: url(\'/static/img/intro.jpg\')"> <div class="container"> <div class="row"> <div class="col-md-8 col-md-offset-2"> <h1 class="title">Welcome to CompleteSearch</h1> <h4>An ultimate search engine.</h4> </div> </div> </div> </div> <div id="content"></div> <footer class="footer"> <div class="container"> <nav class="pull-left"> <ul> <li> <a href="#">About</a> </li> </ul> </nav> <div class="links pull-right"> <a href="https://github.com/anatskiy/CompleteSearch"><i class="fa fa-github" aria-hidden="true"></i></a> </div> </div> </footer>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div> <div class="main main-raised how-to-search"> <div class="container"> <div class="row"> <div class="col-md-6 col-md-offset-3"> <h3 class="title text-center">How to search</h3> <ul> <li>tip 1</li> <li>tip 2</li> <li>tip 3</li> </ul> </div> </div> </div> </div> <div class="section-gray completesearch-search"> <div class="container"> <div class="row"> <div class="col-sm-8"> <div class="card"> <div class="content"> <div class="card-description search-bar"> <div class="input-group"> <input type="search" id="search" class="form-control" placeholder="Search..."> <span class="input-group-btn"> <button id="search-button" class="btn btn-raised btn-primary" type="button"> <i class="fa fa-search" aria-hidden="true"></i> </button> </span> </div> </div> </div> </div> <div class="card"> <div class="content"> <h4 class="card-title">Result</h4> <div class="card-description"> <div id="hits"></div> <div id="empty-text">Nothing to show.</div> <div id="loader"></div> </div> </div> </div> </div> <div class="col-sm-4 hidden-xs"> <div id="facets"></div> </div> </div> </div> </div> </div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="main main-raised"> <div class="container"> <div class="completesearch-upload text-center"> <div class="row"> <div class="col-md-6 col-md-offset-3"> <h2 class="title">Upload database</h2> <div id="upload-form" class="form-group"> <input type="file" id="input-file" name="file"> <div class="input-group"> <input type="text" readonly="" class="form-control" placeholder="Select a file..."> <span class="input-group-addon"> <i class="material-icons">attachment</i> </span> </div> </div> <p> <strong>*Note: </strong>Only XML, CSV, TSV and TXT (with whatever separated data) are accepted. </p> <button id="upload-button" class="btn btn-raised btn-primary">Upload</button> </div> </div> </div> </div> </div>';
}
return __p;
};
...
var _configure = require('../templates/configure.jst');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    selectAll: function selectAll(e) {
        var param = $(e.target).attr('id').replace('-select-all', '');
        var inputs = $('input[name=' + param + ']');
    ...
    checkValues: function checkValues(values) {
        if (values['--full-text'].length === 0 && values['--filter'].length === 0 && values['--facets'].length === 0) {
            noty({
                type: 'error',
...
},{"../../vendor/vendor":32,"../templates/configure.jst":9}],16:[function(require,module,exports){
'use strict';
...
var _facet = require('../templates/facet.jst');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    showTopButtons: function showTopButtons() {
        var length = this.model.get('facetItems').length,
    ...
    topBtnClick: function topBtnClick(e) {
        var limit = parseInt(e.target.text.split(' ')[1]);

        this.model.get('facetItems').each(function (item, idx) {
    ...
    topAllBtnClick: function topAllBtnClick(a, b, c) {
        this.model.get('facetItems').each(function (item) {
            $('#facet-item-' + item.cid).parent().toggleClass('hidden', false);
        });
    }
});

},{"../../vendor/vendor":32,"../templates/facet.jst":10}],17:[function(require,module,exports){
'use strict';
...
var _Facet = require('../collections/Facet');

var _Facet2 = _interopRequireDefault(_Facet);

var _Facet3 = require('./Facet');

var _Facet4 = _interopRequireDefault(_Facet3);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _vendor.Marionette.CollectionView.extend({
    collection: new _Facet2.default(),
    childView: _Facet4.default
});

},{"../../vendor/vendor":32,"../collections/Facet":2,"../templates/facet.jst":10,"./Facet":16}],18:[function(require,module,exports){
'use strict';
...
var _index = require('../templates/index.jst');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    start: function start() {
        var contentRegion = app.getContentRegion();
        contentRegion.empty();
        contentRegion.show(new _Upload2.default());
    }
});

},{"../../vendor/vendor":32,"../templates/index.jst":11,"./Upload":21}],19:[function(require,module,exports){
'use strict';
...
var _main = require('../templates/main.jst');
...
var _Config = require('../collections/Config');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    onRender: function onRender() {
        ...
        // TODO: move it to UploadView
        var configCollection = new _Config2.default();
        configCollection.fetch({
            success: function success() {
                _this.showChildView('content', new _Configure2.default({
...
},{"../../vendor/vendor":32,"../collections/Config":1,"../templates/main.jst":12,"./Configure":15,"./Index":18,"./Search":20}],20:[function(require,module,exports){
'use strict';
...
var _search = require('../templates/search.jst');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    onRender: function onRender() {
        ...
        var facetListView = new _FacetList2.default();

        // Show all facets
        facetListView.collection.fetch({
            success: function success() {
                facetListView.collection.each(function (facet) {
                    var items = facet.get('items');
                    facet.get('facetItems').add(items);
                    facet.unset('items');
                });
                _this.showChildView('facets', facetListView);
            }
        });
    ...
    search: function search() {
        var query = this.getUI('search').val(),
...
},{"../../vendor/vendor":32,"../templates/search.jst":13,"./FacetList":17}],21:[function(require,module,exports){
'use strict';
...
var _upload = require('../templates/upload.jst');
...
exports.default = _vendor.Marionette.View.extend({
    ...
    upload: function upload() {
        var inputFile = this.getUI('inputFile');
        var supportedFileTypes = ['text/tab-separated-values', 'text/csv', 'text/plain', 'text/xml'];
                ...
                $.ajax({
                    ...
                    success: function success(data) {
                        ...
                        if (data.success) {
                            ...
                            var contentRegion = app.getContentRegion();
                            contentRegion.empty();
                            contentRegion.show(new _Search2.default());
                        } else {
                            // TODO: stop loader
...
},{"../../vendor/vendor":32,"../templates/upload.jst":14,"./Search":20}],22:[function(require,module,exports){
...
},{"backbone":24,"backbone.radio":23,"underscore":31}],23:[function(require,module,exports){
...
},{"backbone":24,"underscore":31}],24:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
},{"jquery":29,"underscore":31}],25:[function(require,module,exports){
require("./material.js");
require("./ripples.js");
},{"./material.js":26,"./ripples.js":27}],26:[function(require,module,exports){
/* globals jQuery */
...
},{"jquery":29}],31:[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{"backbone":24,"backbone.marionette":22,"jquery":29,"underscore":31}]},{},[5]);
